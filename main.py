...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_users", default=8, type=int, metavar='N', help='Number of users')
    parser.add_argument("--power_t", default=42, type=float, metavar='N', help='Transmission power for the constrained optimization in dB')
